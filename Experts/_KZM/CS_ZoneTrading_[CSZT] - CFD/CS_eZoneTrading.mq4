...
extern double     Capital_A           =0.5;          //Capital : Order [A]
extern double     Capital_B           =0.5;          //Capital : Order [B]
         ...
         if(DeadLine<=0 && ArraySize(TroopA)>=2)
           {
            //HLineCreate_(0,"LINE_DraftDeadLine","",0,Bid,clrMagenta,1,0,true,true,false,0);
             HLineCreate(0,"LINE_DraftDeadLine","",0,Bid,clrMagenta,1,0,0,true,true,false,0);
