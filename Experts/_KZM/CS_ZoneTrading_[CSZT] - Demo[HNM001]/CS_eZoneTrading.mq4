...
#property strict "s"
#property description "# Demo Only !!" 
...
bool       Calculate_Margin=false;        //Calculate margin
...
bool       Auto_RSI          =true;         //#Pending Chicago
int        Auto_RSI_period=24;              //#Chicago RSI Period
extern string     extline2="________ TakeProfits Gimmicks ________";//---
bool       TP_UseATR         =false;        //ATR tTP
bool       TP_UseSPREAD      =false;        //ATR tTP-SPREAD
extern int        Slippage=100;            //Slippage (Point)
      ...
      if(chkOwner || (!chkOwner && Obj_A_cnt==0))
        {
         ...
         if(DeadLine<=0 && ArraySize(TroopA)>=2)
           {
            HLineCreate_(0,"LINE_DraftDeadLine","",0,Bid,clrMagenta,1,0,true,true,false,0);
