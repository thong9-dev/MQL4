      ...
      if(chk32>0)
        {
         ...
         datetime MODIFY=FileGetInteger(chk32,FILE_MODIFY_DATE);
      ...
      if(chkUpdate)
        {
         ...
         int filehandle;
         filehandle=FileOpen("curl\\bin32\\"+FileName_Token,FILE_WRITE|FILE_CSV);
         FileClose(filehandle);
         filehandle=FileOpen("curl\\bin64\\"+FileName_Token,FILE_WRITE|FILE_CSV);
         FileClose(filehandle);
