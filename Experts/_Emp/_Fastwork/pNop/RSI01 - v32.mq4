...
extern double           setOpen_Buy_1=1.0001;
extern double           setOpen_Sel_1=1.0001;
extern int              setBarA_11=1;                  //BarBefore_1 (Open)
extern int              setBarB_11=0;                  //BarPeer_1 (Open)
extern string           exs_3=" # ";// #
extern double           setClose_Buy_1=0.0001;
extern double           setClose_Sel_1=0.0001;        //setClose_Sell_1
extern int              setBarA_12=1;                  //BarBefore_1 (Close)
extern int              setBarB_12=0;                  //BarPeer_1 (Close)
extern string           exs_4=" ------------------ "; // ---------------------------- RSI 2
extern int              RSI_Period_2=14;
extern ENUM_TIMEFRAMES  RSI_TF_2=PERIOD_CURRENT;      //RSI_TF_2 #(current=off)
extern double           setOpen_Buy_2=0.0001;
extern double           setOpen_Sel_2=0.0001;         //setOpen_Sell_2
extern int              setBarA_2=1;                  //BarBefore_2
extern int              setBarB_2=0;                  //BarPeer_2
extern string           exs_5=" ------------------ "; // ---------------------------- RSI 3
extern int              RSI_Period_3=14;
extern ENUM_TIMEFRAMES  RSI_TF_3=PERIOD_CURRENT;      //RSI_TF_3 #(current=off)
extern double           setOpen_Buy_3=0.0001;
extern double           setOpen_Sel_3=0.0001;         //setOpen_Sell_3
extern int              setBarA_3=1;                  //BarBefore_3
extern int              setBarB_3=0;                  //BarPeer_3
extern string           exs_6=" --------------------------------- ";// ---------------------------------
...
//---
   ...
   setOpen_Buy_1=NormalizeDouble(setOpen_Buy_1,RSI_Digits);
   setClose_Buy_1=NormalizeDouble(setClose_Buy_1,RSI_Digits);
   setOpen_Sel_1=NormalizeDouble(setOpen_Sel_1,RSI_Digits);
   setClose_Sel_1=NormalizeDouble(setClose_Sel_1,RSI_Digits);

   setOpen_Buy_2=NormalizeDouble(setOpen_Buy_2,RSI_Digits);
   setOpen_Sel_2=NormalizeDouble(setOpen_Sel_2,RSI_Digits);

   setOpen_Buy_3=NormalizeDouble(setOpen_Buy_3,RSI_Digits);
   setOpen_Sel_3=NormalizeDouble(setOpen_Sel_3,RSI_Digits);
...
//--- Signal_In
   ...
   int OP_Dir_Inn_1=Signal_RSI("Open",RSI_TF_1,RSI_Period_1,setOpen_Buy_1,setOpen_Sel_1,Dis_Inn_1,setBarA_11,setBarB_11);
   int OP_Dir_Inn_2=Signal_RSI("Open",RSI_TF_2,RSI_Period_2,setOpen_Buy_2,setOpen_Sel_2,Dis_Inn_2,setBarA_2,setBarB_2);
   int OP_Dir_Inn_3=Signal_RSI("Open",RSI_TF_3,RSI_Period_3,setOpen_Buy_3,setOpen_Sel_3,Dis_Inn_3,setBarA_3,setBarB_3);
// Signal Hub

   int OP_Dir_Inn=Signal_RSI_Hub(OP_Dir_Inn_1,OP_Dir_Inn_2,OP_Dir_Inn_3);
//--- Signal_Out
   int OP_Dir_Out_Buy=Signal_RSI("Close",RSI_TF_1,RSI_Period_1,setClose_Buy_1,setClose_Sel_1,Dis_OutBuy,setBarA_12,setBarB_12);
   int OP_Dir_Out_Sel=Signal_RSI("Close",RSI_TF_1,RSI_Period_1,setClose_Buy_1,setClose_Sel_1,Dis_OutSell,setBarA_12,setBarB_12);
...
int Signal_RSI(string Mode,int TF,int Period_,double setBuy,double setSel,double &RSI_X,
               int Bar_1,int Bar_0)
  {
   ...
   double setBuy_T=setBuy+(Tolerance*getNegative(setBuy));
   double setSel_T=setSel+(Tolerance*getNegative(setSel));
   ...
   if(TF!=PERIOD_CURRENT)
     {
      ...
      RSI_0=NormalizeDouble(iRSI(Symbol(),TF,Period_,PRICE_CLOSE,Bar_0),RSI_Digits);
      RSI_1=NormalizeDouble(iRSI(Symbol(),TF,Period_,PRICE_CLOSE,Bar_1),RSI_Digits);
      ...
      if(Mode=="Open")
        {
         if(RSI_X>0)
           {
            ...
            //---
            if(setBuy>0 && setSel>0)
              {
               if(OP_BUY_Dir!=-1 && OP_Sel_Dir!=-1)
                 {
                  if(setBuy>=setSel)
                     OP_Dir=OP_BUY_Dir;
                  else
                 ...
                 {
                  if(OP_BUY_Dir!=-1) OP_Dir=OP_BUY_Dir;
                  if(OP_Sel_Dir!=-1) OP_Dir=OP_Sel_Dir;
                 }
              }
            else
              {
               if(setBuy>0)   OP_Dir=OP_BUY_Dir;
               if(setSel>0)   OP_Dir=OP_Sel_Dir;
              }
            //---
         ...
         if(RSI_X<0)
           {
            if(
               ((RSI_X<=setSel) && (RSI_X>=setSel) && (Tolerance!=0)) ||
               ((RSI_X<=setSel) && (Tolerance==0))
               )
              {
               OP_Sel_Dir=OP_SELL;
            ...
            if(
               ((RSI_X<=setBuy) && (RSI_X>=setBuy) && (Tolerance!=0)) ||
               ((RSI_X<=setBuy) && (Tolerance==0))
               )
              {
               OP_BUY_Dir=OP_BUY;
...
//|                                                                  |
//+------------------------------------------------------------------+
int Signal_RSI_(string Mode,int TF,int Period_,double setBuy,double setSel,double &RSI_X)
  {
