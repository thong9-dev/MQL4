...
//+------------------------------------------------------------------+
class CPanelDialog2 : public CAppDialog
  {
private:
...
//| Create                                                           |
//+------------------------------------------------------------------+
bool CPanelDialog2::Create(const long chart,const string name,const int subwin,const int x1,const int y1,const int w,const int h)
  {
    int x2=x1+w;
  int y2=y1+h;
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateEdit(void)
  {
//--- coordinates
   int x1=INDENT_LEFT;
   int y1=INDENT_TOP;
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateButton1(void)
  {
//--- coordinates
...
//--- create
   if(!m_button1.Create(m_chart_id,m_name+"ButtonA",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_button1.Text("ButtonA"))
      return(false);
   if(!Add(m_button1))
      return(false);
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateButton2(void)
  {
//--- coordinates
   int x1=ClientAreaWidth()-(INDENT_RIGHT+BUTTON_WIDTH);
   ...
   int y2=y1+BUTTON_HEIGHT;
//--- create
   if(!m_button2.Create(m_chart_id,m_name+"ButtonB",m_subwin,x1,y1,x2,y2))
      return(false);
   if(!m_button2.Text("ButtonB"))
      return(false);
   if(!Add(m_button2))
      return(false);
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateButton3(void)
  {
//--- coordinates
   int x1=ClientAreaWidth()-(INDENT_RIGHT+BUTTON_WIDTH);
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateRadioGroup(void)
  {
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateCheckGroup(void)
  {
   int sx=(ClientAreaWidth()-(INDENT_LEFT+INDENT_RIGHT+BUTTON_WIDTH))/3-CONTROLS_GAP_X;
//--- coordinates
...
//+------------------------------------------------------------------+
bool CPanelDialog2::CreateListView(void)
  {
   int sx=(ClientAreaWidth()-(INDENT_LEFT+INDENT_RIGHT+BUTTON_WIDTH))/3-CONTROLS_GAP_X;
//--- coordinates
...
//| Handler of resizing                                              |
//+------------------------------------------------------------------+
bool CPanelDialog2::OnResize(void)
  {
   printf("OnResize");
...
//| Event handler                                                    |
//+------------------------------------------------------------------+
void CPanelDialog2::OnClickButton1(void)
  {
...
//| Event handler                                                    |
//+------------------------------------------------------------------+
void CPanelDialog2::OnClickButton2(void)
  {
   m_edit.Text(__FUNCTION__);
  }
//+------------------------------------------------------------------+
//| Event handler                                                    |
//+------------------------------------------------------------------+
void CPanelDialog2::OnClickButton3(void)
  {
...
//| Event handler                                                    |
//+------------------------------------------------------------------+
void CPanelDialog2::OnChangeListView(void)
  {
...
//| Event handler                                                    |
//+------------------------------------------------------------------+
void CPanelDialog2::OnChangeRadioGroup(void)
  {
...
//| Event handler                                                    |
//+------------------------------------------------------------------+
void CPanelDialog2::OnChangeCheckGroup(void)
  {
...
//| Rest events handler                                                    |
//+------------------------------------------------------------------+
bool CPanelDialog2::OnDefault(const int id,const long &lparam,const double &dparam,const string &sparam)
  {
