...
void _setBUTTON(string name,int panel,
                int XDIS,int YDIS,
                int XSIZE,int YSIZE,
                color COLOR,color BG,int FONTSIZE,string Text)
  {
//---
...
//|                                                                  |
//+------------------------------------------------------------------+
bool _LabelSet(string name,int panel,int CORNER,int x,int y,color clr,string front,int Size,string text,string tooltip)
  {
   if(ObjectFind(panel,name)<=0)
     {
      ObjectCreate(name,OBJ_LABEL,panel,0,0);
     }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+  
//string           InpName="Edit";              // Object name 
//string           InpText="Text";              // Object text 
input string           InpFont="Arial";             // Font 
int              InpFontSize=14;              // Font size 
ENUM_ALIGN_MODE  InpAlign=ALIGN_CENTER;       // Text alignment type 
bool             InpReadOnly=false;           // Ability to edit 
ENUM_BASE_CORNER InpCorner=CORNER_LEFT_UPPER; // Chart corner for anchoring 
                                              //color            InpColor=clrBlack;           // Text color 
color            InpBackColor=clrWhite;       // Background color 
color            InpBorderColor=clrBlack;     // Border color 
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
...
void setTemplate()
  {
   ...
   ChartSetInteger(0,CHART_COLOR_VOLUME,clrDarkGreen);
